...
public class BackendDummy implements BackendInterface {
    ...
    /**
     * Method to add a genre that the user selected. It will output but not store the ratings passed
     * to it.
     */
    @Override
    ...
    /**
     * Method to remove a genre that the user selected. It will output but not remove the genre passed
     * to it from the backend object.
     */
    @Override
    ...
    /**
     * Method to remove a rating that the user selected. It will output but not remove the genre
    ...
    /**
     * Return the genres added to this backend object. The dummy implementation always returns the
     * same list of genres for testing.
     */
    @Override
    ...
    /**
     * Return the ratings added to this backend object. The dummy implementation always returns the
     * same list of ratings for testing.
     */
    @Override
    ...
    /**
     * Returns all genres in the dataset. Will return a list of 5 genres for the dummy
     * implementation.
     */
    @Override
