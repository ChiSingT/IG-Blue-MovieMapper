...
public class TestFrontend {
	...
	public void runTests() {
		...
		System.out.print(
				"Test frontend initially lists no movie (WARNING: if 'x' does not exit app, test won't exit and run indefinitely!): ");
		...
		System.out.print(
				"Test 'g' load genre selection screen (WARNING: if pressing 'x' twice from the genre selection screen does not exit app, test won't exit and run indefinitely!): ");
		...
		System.out.print(
				"Test genre selection screen shows all genres (WARNING: if pressing 'x' twice from the genre selection screen does not exit app, test won't exit and run indefinitely!): ");
		...
		System.out.print(
				"Test initial rating selection screen has all ratings selected(WARNING: if pressing 'x' twice from the genre selection screen does not exit app, test won't exit and run indefinitely!): ");
	...
	public boolean testFrontendAllRatingsSelected() {
		...
		try {
			...
			System.setIn(standardIn);
			String appOutput = outputStreamCaptor.toString();
			if (frontend == null || !appOutput.contains("[x] 0-0.999\n"
					+ "[x] 1-1.999\n"
					+ "[x] 2-2.999\n"
					+ "[x] 3-3.999\n"
					+ "[x] 4-4.999\n"
